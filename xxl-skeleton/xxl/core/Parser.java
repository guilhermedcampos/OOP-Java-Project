...
public class Parser {
  ...
  Spreadsheet parseFile(String filename)
      throws IOException, UnrecognizedEntryException, EvaluationException, OutOfBoundsException /* More Exceptions? */ {
  ...
  private Content parseContentExpression(String contentSpecification)
      throws UnrecognizedEntryException, EvaluationException, OutOfBoundsException /* more exceptions */ {
